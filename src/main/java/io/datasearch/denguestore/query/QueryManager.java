...
public class QueryManager {
	...
	public List<QueryObject> readQueriesFromFile() throws Exception {
		...
		List<Map<String, String>> yml_object = (List<Map<String, String>>) yml.get("queries");
		for(Map<String, String> i:yml_object) {
	...
	public void runQueries() throws Exception {
		...
		for(QueryObject obj: queries) {
			...
			FeatureReader<SimpleFeatureType, SimpleFeature> reader = dataStore.getFeatureReader(obj.query,Transaction.AUTO_COMMIT);
