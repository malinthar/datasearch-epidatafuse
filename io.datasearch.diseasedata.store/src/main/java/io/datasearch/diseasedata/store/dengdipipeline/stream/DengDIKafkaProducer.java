...
/**
 * Producer for ingesting Events into kafka.
 */
public class DengDIKafkaProducer {
    ...
    public void initProducer(String... args) throws Exception {
        if (args.length == 0) {
            runProducer(5);
        } else {
    ...
    private static Producer<Long, String> createProducer() {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG,
                BOOTSTRAP_SERVERS);
        props.put(ProducerConfig.CLIENT_ID_CONFIG, "DengDIKafkaProducer");
